...
set SRCfolder src
## recipf
set SRCfiles [list Block_proc.vhd Block_proc_assertudo.vhd Block_proc_assertyd2.vhd getRequestHead_OBJ.vhd running_ASSERT_FLOAT.vhd running_ASSERT_FLOAT_4.vhd topTesting.vhd topTesting_fmul_3jbC.vhd Block_proc_assertrcU.vhd Block_proc_assertvdy.vhd Block_proc_words32.vhd getRequestHead_OBbkb.vhd running_ASSERT_FLOAT_1.vhd running_ASSERT_FLOAT_5.vhd topTesting_bufferzec.vhd topTesting_frecipmb6.vhd Block_proc_assertsc4.vhd Block_proc_assertwdI.vhd buildResponse_OBJ.vhd l2norm_assert.vhd running_ASSERT_FLOAT_2.vhd running_ASSERT_FLcud.vhd topTesting_fadd_3ibs.vhd topTesting_fsqrt_lbW.vhd Block_proc_asserttde.vhd Block_proc_assertxdS.vhd forward_OBJ.vhd l2norm_assert_hishbi.vhd running_ASSERT_FLOAT_3.vhd running_ASSERT_FLdEe.vhd topTesting_fcmp_3kbM.vhd]
